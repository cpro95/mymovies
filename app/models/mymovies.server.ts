...
export async function addMyMoviesById(movie_id: string, title: string, original_title: string, poster_path: string, release_date: string, genres: string, vote_average: string, userId: string) {
...
export async function getMyMoviesCount(id: string, query?: string, genreId?: string) {
    // console.log(query);
    // console.log(genreId);
    ...
    else return prisma.mymovies.count({
        where: {
            AND: [
                {
                    userId: id,

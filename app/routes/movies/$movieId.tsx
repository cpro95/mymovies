...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  // console.log("Prefetching Movie... -->", movie.title);
...
const AddToDBComponent: React.FC<AddToDBComponentType> = ({
  movie_id,
  title,
  original_title,
  poster_path,
...
export default function MovieId() {
  const { userId, movie, isMovieinMyMovies } = useLoaderData();

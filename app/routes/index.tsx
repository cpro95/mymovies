...
import { getPopularMovies } from "~/models/movies.server";
...
import { getRandomInt,DEFAULT_LANGUAGE,  META_DESCRIPTION } from "~/utils/utils";
...
export default function Index() {
  let { popularMovies } = useLoaderData() as MyLoaderData;
